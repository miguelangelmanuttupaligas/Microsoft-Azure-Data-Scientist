...
![alt text](./images/k-means.gif)
![alt text](./images/4-hierarchical-clustering.png)
...
- Capas: realizan una tarea específica
  ...
  - ![alt text](./images/convolutional-neural-network.png)
